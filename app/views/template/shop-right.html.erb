...
<header>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pulse animated">
                            <li class="active"><a href="shop-right.html">Shop: Right Sidebar</a></li>
    ...
    <div id="page-header" class="shop-right">
        <div class="container">
            <div class="page-header-content text-center">
                <div class="page-header wsub">
                    <h1 class="page-title fadeInDown animated first">Shop - Right Sidebar</h1>
                </div><!-- / page-header -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8 col-md-9 content-area">
                <p class="shop-results">Showing <strong>1-12</strong> of <strong>36</strong> items. 
                ...
                <div class="pagination">
                    <button type="button" class="btn btn-direction btn-default btn-rounded"><i class="lnr lnr-chevron-left"></i></button>
                    <button type="button" class="btn btn-default btn-rounded btn-active">1</button>
                    <button type="button" class="btn btn-default btn-rounded">2</button>
                    <button type="button" class="btn btn-default btn-rounded">3</button>
                    <button type="button" class="btn btn-direction btn-default btn-rounded"><i class="lnr lnr-chevron-right"></i></button>
                </div>
